...
export const LaserFlow = ({
  ...
  useEffect(() => {
    ...
    const renderer = new THREE.WebGLRenderer({
      antialias: false,
      alpha: true, // true to allow opacity on section backgrounds
      depth: false,
      stencil: false,
    ...
    renderer.setClearColor(0x000000, 0); // clear with 0 alpha
    ...
    // Bind to window to allow pointer-events: none to work smoothly
